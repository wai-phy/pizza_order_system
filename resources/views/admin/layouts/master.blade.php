            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list"> 
                        ...
                        <li>
                            <a class="text-decoration-none" href="{{ route('product#pizzaPage')}}">
                                <i class="fa-solid fa-pizza-slice"></i>Product</a>
                        </li>
                        <li>
                            <a class="text-decoration-none" href="{{ route('admin#orderList')}}">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <span>
                                <h4><b>Admin Dashboard Panel</b></h4>
                            </span>
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__footer">
                                                <form action="{{ route('logout')}}" class="d-flex justify-content-center" method="post">
                                                    @csrf
                                                    <button class="btn btn-dark px-4 mb-2"><i class="zmdi zmdi-power"></i>  Logout</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
